...
[
    ...
    'ascii' => "Das :attribute  darf nur alphanumerische Single-Byte-Zeichen und -Symbole enthalten.",
    ...
    'decimal' => "Das :attribute  muss :dateecimal Nachkommastellen haben.",
    ...
    'doesnt_end_with' => "Das :attribute  darf nicht mit einem der folgenden enden: :value s.",
    'doesnt_start_with' => "Das :attribute  darf nicht mit einem der folgenden Zeichen beginnen: :value s.",
    ...
    'lowercase' => "Das :attribute  muss in Kleinbuchstaben geschrieben werden.",
    'lt' => 
        [
    ...
    'required_if_accepted' => "Das Feld :attribute  ist erforderlich, wenn :it akzeptiert wird.",
    ...
    'size' => 
        [
            'array' => "Das :attribute  muss :secondsize -Elemente enthalten.",
            'file' => "Das :attribute  muss :secondsize  Kilobyte sein.",
            'numeric' => "Das :attribute  muss :secondsize  sein.",
            'string' => "Das :attribute  muss :secondsize -Zeichen sein.",
        ],
